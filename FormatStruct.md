...
| 0x8 | 0x4 | UInt32 | HashTable section offset, always 0x10 and same value in all pack files |
...
| Offset | Size | Type | Description |
| --- | --- | --- | --- |
| 0x00 | 0x4  | UInt32 | HashTable Entry Count, dividing this value by 2 should return the File Count |
